...
def test_dashboard_renders(authenticated_page: Page):
    ...
    expect(authenticated_page.locator("#mission-target")).to_be_visible()
    expect(authenticated_page.locator("#launch-btn")).to_be_visible()
...
def test_getting_started_links_to_settings(authenticated_page: Page, app_url: str):
    ...
    getting_started = authenticated_page.locator("#getting-started")
