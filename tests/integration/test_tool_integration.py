...
from app.services.tools.models import ToolConfig, InstallationConfig, ExecutionConfig, ToolCategory, ToolStatus
...
def integration_context(mock_registry):
    ...
    with patch("app.services.tools.service.get_registry", return_value=mock_registry), \
