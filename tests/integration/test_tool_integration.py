...
from spectra_tools_core.registry import RegisteredTool, ToolRegistry
...
def integration_context(mock_registry):
    ...
    with (
        patch("spectra_tools.validation.get_registry", return_value=mock_registry),
        patch("spectra_tools.service.SafetySupervisorAgent") as MockSafetyAgent,
        patch("spectra_tools.service.VotingSystem") as MockVotingSystem,
        patch("spectra_ai_core.agents.tool_selector.ToolSelectorAgent") as MockToolSelector,
    ):
