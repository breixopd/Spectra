...
from spectra_ai_core.agents.base import ActionRisk, AgentContext, ToolAction
from spectra_ai_core.agents.safety import (
    SafetyAction,
    SafetyInput,
    SafetySupervisorAgent,
)
from spectra_ai_core.consensus import ConsensusStatus, QualityGate, VotingSystem
...
class TestTaskFailureHandling:
    ...
    async def test_task_failure_triggers_replan(self, mission_manager: MissionManager, test_target_ip: str):
        ...
        from spectra_ai_core.agents.mission_controller import MissionInput
        ...
        async def mock_execute(context, input_data):
            ...
            from spectra_ai_core.agents.base import AgentResult
