...
from app.services.tools.service import ToolExecutionService, ToolExecutionRequest, ToolExecutionResult
from app.services.tools.models import RegisteredTool, ToolStatus, ToolConfig, OutputFormat
from app.services.ai.agents.safety import SafetyAction
from app.services.ai.agents.base import ActionRisk

@pytest.fixture
def mock_service_context():
    with patch("app.services.tools.service.get_registry") as mock_get_registry, \
