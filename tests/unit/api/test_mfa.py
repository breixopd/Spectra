...
from spectra_auth.security import decrypt_mfa_secret, encrypt_mfa_secret, verify_totp
...
async def test_login_with_mfa_requires_code():
    ...
    from spectra_auth.security import create_access_token
...
async def test_login_with_mfa_returns_token_after_verify(mock_session):
    ...
    from spectra_api.api.schemas.auth import MFAVerifyRequest
    from spectra_auth.security import create_access_token, decode_token
