...
class TestExploitChainStorage:
    ...
    def test_load_custom_chains_empty(self, tmp_path):
        from spectra_mission.chain_builder import load_custom_chains

        # With no file, should return empty
        with patch("spectra_mission.chain_builder.CUSTOM_CHAINS_PATH", tmp_path / "chains.json"):
            from spectra_mission import chain_builder
    ...
    def test_save_and_load_custom_chain(self, tmp_path):
        import spectra_mission.chain_builder as cb_module
