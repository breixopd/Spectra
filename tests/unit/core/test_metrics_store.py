...
from spectra_infra.metrics_store import MetricsStore, get_metrics_store
...
class TestTakeSnapshot:
    def test_snapshot_appends_to_history(self):
        ...
        with patch("spectra_observability.telemetry.telemetry") as mock_telemetry:
...
class TestGetMetricsStoreSingleton:
    def test_returns_instance(self):
        import spectra_infra.metrics_store as mod
