...
class TestDirectModuleImports:
    ...
    def test_auth_module(self):
        from spectra_api.api.schemas.auth import Token, TokenData, UserBase, UserCreate, UserResponse
    ...
    def test_mission_module(self):
        from spectra_api.api.schemas.mission import (
    ...
    def test_tool_module(self):
        from spectra_api.api.schemas.tool import (
            InstallToolRequest,
            InstallToolResponse,
...
class TestSchemaValidation:
    ...
    def test_health_response_valid(self):
        from spectra_api.api.schemas.system import HealthResponse
    ...
    def test_install_tool_request_pattern(self):
        from spectra_api.api.schemas.tool import InstallToolRequest
