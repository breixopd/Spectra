...
from spectra_platform.mission.core.state_machine import (
    VALID_TRANSITIONS,
    MissionStateMachine,
    StateTransition,
)
...
class TestTelemetryOnTransition:
    ...
    def test_transition_increments_counter(self):
        with patch("spectra_platform.mission.core.state_machine._telemetry") as mock_tel, patch("spectra_platform.mission.core.state_machine.events"):
...
class TestFullLifecycle:
    ...
    def test_created_to_completed(self):
        with patch("spectra_platform.mission.core.state_machine._telemetry"), patch("spectra_platform.mission.core.state_machine.events"):
