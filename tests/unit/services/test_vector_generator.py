...
from spectra_ai_core.agents.vector_generator import (
...
class TestVectorGeneratorAgent:
    ...
    async def test_execute_with_deterministic_vectors(self):
        ...
        with patch("spectra_ai_core.knowledge.get_exploit_context", new_callable=AsyncMock, return_value=""):
            with patch(
                "spectra_ai_core.knowledge.get_available_tools_context", new_callable=AsyncMock, return_value=""
            ):
