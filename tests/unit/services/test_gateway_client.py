...
from spectra_ai_core.gateway.http_client import MAX_RETRIES, GatewayClient
...
class TestGatewayClientRequest:
    ...
    async def test_retries_on_connection_error_then_succeeds(self, client: GatewayClient):
        with (
            ...
            patch("spectra_ai_core.gateway.http_client.asyncio.sleep", new_callable=AsyncMock),
        ):
