...
STORAGE_PATCH = "spectra_storage_policy.storage.service.get_storage_service"
...
def backup_svc(tmp_path):
    ...
    with (
        patch("spectra_scaling.infrastructure_services.backup.BackupService.__init__", return_value=None),
