...
from spectra_system.email.providers.console import ConsoleProvider
...
@patch("spectra_system.email.service.settings")
def test_get_provider_returns_smtp_when_host_configured(mock_settings):
    ...
    from spectra_system.email.providers.smtp import SMTPProvider
    from spectra_system.email.service import _get_provider
...
@pytest.mark.asyncio
@patch("spectra_system.email.providers.smtp.settings")
async def test_smtp_provider_send_success(mock_settings):
    ...
    with patch("spectra_system.email.providers.smtp.aiosmtplib", create=True) as mock_aio:
        mock_send = AsyncMock()
