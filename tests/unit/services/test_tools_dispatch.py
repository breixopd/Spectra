...
class TestBuildExecutionRequest:
    @patch("spectra_tools.dispatch.prepare_output_directory", return_value="/tmp/output")
    ...
    @patch("spectra_tools.dispatch.prepare_output_directory", return_value="/tmp/out")
...
class TestDispatchAndProcessResult:
    @pytest.mark.asyncio
    @patch("spectra_tools.dispatch.persist_output_directory", new_callable=AsyncMock, return_value=0)
    @patch("spectra_tools.dispatch.cleanup_output_directory")
    @patch("spectra_tools.dispatch.execute_via_worker", new_callable=AsyncMock)
    @patch("spectra_tools.dispatch.truncate_for_llm", side_effect=lambda s, **kw: s)
    @patch("spectra_tools.dispatch.log_success")
    @patch("spectra_tools.dispatch.update_attack_surface_from_finding")
    ...
    @pytest.mark.asyncio
    @patch("spectra_tools.dispatch.persist_output_directory", new_callable=AsyncMock)
    @patch("spectra_tools.dispatch.cleanup_output_directory")
    @patch("spectra_tools.dispatch.execute_via_worker", new_callable=AsyncMock)
    @patch("spectra_tools.dispatch.truncate_for_llm", side_effect=lambda s, **kw: s)
    @patch("spectra_tools.dispatch.log_success")
