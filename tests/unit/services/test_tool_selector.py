...
from spectra_ai_core.agents.base import ActionRisk, AgentContext
...
class TestToolSelectorExecution:
    ...
    async def test_execute_returns_result(self, mock_llm, context):
        ...
        with patch("spectra_ai_core.agents.tool_selector.get_registry") as mock_registry:
            mock_tool = MagicMock()
    ...
    async def test_execute_with_no_available_tools(self, context):
        ...
        from spectra_ai_core.agents.tool_selector import ToolSelectorOutput
