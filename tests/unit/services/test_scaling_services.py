...
from app.services.scaling import docker_client, image_updater, metrics_collector, node_metrics
...
async def test_image_update_dry_run_records_available_update(monkeypatch):
    ...
    monkeypatch.setattr("app.services.scaling.docker_client.get_service", fake_get_service)
    monkeypatch.setattr("app.services.scaling.docker_client.get_registry_digest", fake_get_registry_digest)
    monkeypatch.setattr("app.services.scaling.docker_client.update_service_image", fail_update_service_image)
...
async def test_image_update_applies_update_and_records_rollback(monkeypatch):
    ...
    monkeypatch.setattr("app.services.scaling.docker_client.get_service", fake_get_service)
    monkeypatch.setattr("app.services.scaling.docker_client.get_registry_digest", fake_get_registry_digest)
    monkeypatch.setattr("app.services.scaling.docker_client.update_service_image", fake_update_service_image)
...
async def test_collect_node_metrics_counts_docker_containers_outside_event_loop(monkeypatch):
    ...
    monkeypatch.setattr("app.services.scaling.docker_client.count_running_containers", fake_count_running_containers)
...
async def test_metrics_collector_returns_compose_replicas_when_swarm_unavailable(monkeypatch):
    ...
    monkeypatch.setattr("app.services.scaling.metrics_collector.list_services", no_swarm_services, raising=False)
    monkeypatch.setattr("app.services.scaling.docker_client.list_services", no_swarm_services)
    monkeypatch.setattr("app.services.scaling.docker_client.list_running_containers", compose_containers)
    monkeypatch.setattr("app.services.scaling.docker_client.get_container_stats", slow_stats)
...
async def test_collect_queue_metrics(monkeypatch):
    ...
    monkeypatch.setattr("app.infrastructure.queue.queue_metrics", fake_queue_metrics)
