...
from spectra_ai_core.errors import LLMParseError
from spectra_domain.enums import AssessmentPhase
...
def controller(mock_llm):
    with patch("spectra_ai_core.consensus.VotingSystem"):
...
class TestCreateMissionPlan:
    ...
    async def test_successful_plan_creation(self, controller, context, mock_llm):
        ...
        with (
            ...
            patch(
                "spectra_ai_core.knowledge.get_mission_context",
                new_callable=AsyncMock,
                return_value="No similar missions",
            ),
            patch(
                "spectra_ai_core.knowledge.get_full_methodology",
    ...
    async def test_plan_creation_retries_on_failure(self, controller, context):
        ...
        with (
            ...
            patch("spectra_ai_core.knowledge.get_full_methodology", return_value="method"),
        ):
