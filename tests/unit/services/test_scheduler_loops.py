...
from spectra_scaling.image_updater import ImageUpdateResult
...
async def test_send_update_notification_swallows_errors(monkeypatch):
    ...
    monkeypatch.setitem(
        sys.modules,
        "spectra_system.notifications",
        make_module("spectra_system.notifications", send_notification=boom),
    )
