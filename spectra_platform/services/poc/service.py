...
from spectra_platform.services.ai.agents.poc_developer import POCDeveloperAgent, POCDeveloperInput
...
from spectra_platform.services.security.capabilities import Capability, CapabilityRequest, require_capability
