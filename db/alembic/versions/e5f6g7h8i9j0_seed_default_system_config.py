...
_DEFAULTS = [
    ...
    (
        "CORS_ORIGINS",
        "http://localhost:5000,http://127.0.0.1:5000,http://localhost:5050,http://127.0.0.1:5050",
        False,
    ...
    (
        ...
        '{"light": {"memory": "512m", "cpu_shares": 256}, "medium": {"memory": "2g", "cpu_shares": 512}, "heavy": {"memory": "4g", "cpu_shares": 1024}, "extreme": {"memory": "8g", "cpu_shares": 2048}}',
        False,
        "Sandbox resource tier definitions (JSON)",
    ),
