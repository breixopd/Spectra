...
| Release and verification owners | [Testing Strategy](testing-strategy.md) · [Runbooks](runbooks.md) | Validation matrix, `./scripts/runbooks/ci-parity.sh`, pre-release gate |
