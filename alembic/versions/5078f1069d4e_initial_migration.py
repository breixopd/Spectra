...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'SCANNING', 'ANALYZING', 'EXPLOITING', 'COMPLETED', 'FAILED', name='entitystatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('POTENTIAL', 'VERIFIED', 'EXPLOITED', 'FALSE_POSITIVE', name='findingstatus'), nullable=False),
