...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("plan_id", sa.String(), sa.ForeignKey("plans.id", ondelete="RESTRICT"), nullable=False, index=True),
    ...
    op.add_column("users", sa.Column("plan_id", sa.String(), sa.ForeignKey("plans.id", ondelete="SET NULL"), nullable=True))
