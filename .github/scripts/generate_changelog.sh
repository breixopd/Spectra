...
echo "- \`ghcr.io/breixopd/spectra-ai-svc:${VERSION}\`"
echo "- \`ghcr.io/breixopd/spectra-scheduler:${VERSION}\`"
echo "- \`ghcr.io/breixopd/spectra-worker:${VERSION}\`"
echo "- \`ghcr.io/breixopd/spectra-caddy:${VERSION}\`"
