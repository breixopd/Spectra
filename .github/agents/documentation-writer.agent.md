---
description: "Generates technical docs, diagrams, maintains code-documentation parity. Use when: writing documentation, creating architecture diagrams, updating READMEs, maintaining doc parity."
...
- Skynet-specific: docs/ folder has MODEL_GUIDE.md, SECURITY.md, SETUP.md, TOOLS.md, WORKFLOWS.md. README.md at project root.
