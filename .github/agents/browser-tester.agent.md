---
description: "Automates browser testing, UI/UX validation using browser automation tools and visual verification techniques. Use when: testing web UIs, validating dashboard pages, checking accessibility, end-to-end browser testing."
name: browser-tester
...
- Skynet-specific: Dashboard runs on port 5000 inside Docker (proxied via Caddy). Test the dashboard at http://localhost:5000 or the PUBLIC_URL.
