...
| Area | Path | Role |
|------|------|------|
| **CI / verification** | [`runbooks/ci-parity.sh`](runbooks/ci-parity.sh) | Mirror GitHub Actions: static analysis, unit coverage ≥65% across all first-party packages, settings; `all` adds integration. |
