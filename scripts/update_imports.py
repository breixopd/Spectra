...
MOVE_MAP = {
    ...
    "paths": "app.infrastructure.paths",
    ...
    "lifespan": "app.bootstrap.lifespan",
    "middleware": "app.bootstrap.middleware",
    "logging_config": "app.bootstrap.logging_config",
    "templates": "app.bootstrap.templates",
    ...
    "telemetry_middleware": "app.telemetry.telemetry_middleware",
}
...
NEW_PARENT = {
    ...
    "middleware": "app.bootstrap",
    "logging_config": "app.bootstrap",
