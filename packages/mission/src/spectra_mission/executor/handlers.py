...
if TYPE_CHECKING:
    from spectra_ai_core.agents.tool_selector import ToolSelectorInput

from spectra_ai_core.agents.base import AgentContext, ParallelToolAction, ToolAction
from spectra_ai_core.agents.mission_controller import AssessmentPhase, Task
from spectra_ai_core.output_intelligence import extract_intelligence
...
from spectra_mission.executor.utils import detect_target_type
from spectra_mission.task_tree import TaskStatus
from spectra_mission.tool_chain_rules import get_triggered_rules
...
class TaskDispatcher:
    ...
    async def _handle_scope(
        ...
        try:
            ...
            from spectra_ai_core.agents.scope import ScopeInput
    ...
    async def _handle_reporter(
        ...
        try:
            ...
            from spectra_ai_core.agents.reporter import ReporterInput, ReportOutput
    ...
    async def _handle_post_exploitation(
        ...
        try:
            ...
            from spectra_persistence.models.attack_surface import VectorStatus
    ...
    async def _find_alternative_tools(tool_name: str) -> list[dict[str, str]]:
        ...
        """
        from spectra_tools.execution import find_alternative_tools
    ...
    async def _generate_dynamic_vectors(
        ...
        try:
            ...
            from spectra_ai_core.agents.vector_generator import VectorGeneratorInput
