...
from spectra_mission.manager.checkpoint import index_to_rag, record_mission_lessons
from spectra_mission.manager.helpers import (
...
class MissionExecutionManager:
    ...
    async def _create_sandbox(self, mission: Mission) -> Any:
        ...
        try:
            from spectra_system.notifications import notify_mission_started
