...
from spectra_ai_core.blackboard import MissionBlackboard, get_blackboard
from spectra_common.paths import data_path
from spectra_common.tasks import create_safe_task
from spectra_common.utils.geoip import GeoLocation
from spectra_domain.enums import MissionStatus
from spectra_mission.core.state_machine import MissionStateMachine
from spectra_mission.core.websocket import manager as ws_manager
from spectra_mission.credentials import CredentialStore
...
from spectra_mission.types import (
    FindingDict,
    MissionProgress,
    ServiceInfo,
    ToolExecutionRecord,
...
class Mission:
    ...
    def _apply_mitre_tags(self, finding: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            from spectra_ai_core.mitre_attack import tag_finding_with_attack
