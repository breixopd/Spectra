...
from spectra_platform.services.ai.agents.base import Agent, AgentRole
...
def _ensure_all_agents_imported() -> None:
    ...
    _agent_modules = [
        "spectra_platform.services.ai.agents.scope",
        "spectra_platform.services.ai.agents.tool_selector",
        "spectra_platform.services.ai.agents.mission_controller",
        "spectra_platform.services.ai.agents.safety",
        "spectra_platform.services.ai.agents.exploit_crafter",
        "spectra_platform.services.ai.agents.exploit_verifier",
        "spectra_platform.services.ai.agents.poc_developer",
        "spectra_platform.services.ai.agents.post_exploitation",
        "spectra_platform.services.ai.agents.vector_generator",
        "spectra_platform.services.ai.agents.debrief",
        "spectra_platform.services.ai.agents.reporter",
        "spectra_platform.services.ai.agents.recon_intel",
    ]
