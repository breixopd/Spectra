...
from spectra_ai.prompts import TOOL_SELECTION_PROMPT
...
class ToolSelectorAgent(Agent[ToolSelectorInput, ToolSelectorOutput]):
    ...
    async def _select_with_llm(
        ...
        memory_context = ""
        try:
            from spectra_platform.services.ai.memory import detect_os_from_services, get_memory
        ...
        playbook_context = ""
        try:
            from spectra_platform.services.ai.playbook import get_playbook_engine
        ...
        wordlist_context = ""
        try:
            from spectra_platform.services.ai.wordlists import (
