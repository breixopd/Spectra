...
from spectra_platform.services.mission.manager.checkpoint import index_to_rag, record_mission_lessons
from spectra_platform.services.mission.manager.helpers import (
...
class MissionExecutionManager:
    ...
    async def _create_sandbox(self, mission: Mission) -> Any:
        ...
        try:
            from spectra_platform.services.notifications import notify_mission_started
    ...
    async def _run_scope_phase(self, mission: Mission, context: AgentContext) -> None:
        ...
        if not scope_result.success and scope_result.action and not scope_result.action.targets and mission.target:
            from spectra_platform.services.ai.agents.scope import TargetSpec
