...
from spectra_platform.services.ai.agents.base import AgentRole
from spectra_platform.services.ai.agents.registry import get_agent_registry
...
if TYPE_CHECKING:
    ...
    from spectra_platform.services.ai.agents.base import Agent, AgentContext
