...
if TYPE_CHECKING:
    from spectra_platform.services.ai.agents.tool_selector import ToolSelectorInput
...
from spectra_platform.services.mission.executor.utils import detect_target_type
from spectra_platform.services.mission.task_tree import TaskStatus
from spectra_platform.services.mission.tool_chain_rules import get_triggered_rules
...
if TYPE_CHECKING:
    from spectra_platform.services.ai.agents.base import BaseAgent
    from spectra_platform.services.ai.consensus import VotingSystem
    from spectra_platform.services.mission.exploitation import ExploitationManager
...
class TaskDispatcher:
    ...
    async def _handle_scope(
        ...
        try:
            ...
            from spectra_platform.services.ai.agents.scope import ScopeInput
    ...
    async def _handle_reporter(
        ...
        try:
            ...
            from spectra_platform.services.ai.agents.reporter import ReporterInput, ReportOutput
    ...
    async def _handle_post_exploitation(
        ...
        try:
            ...
            from spectra_platform.models.attack_surface import VectorStatus
    ...
    async def _generate_dynamic_vectors(
        ...
        try:
            ...
            from spectra_platform.services.ai.agents.vector_generator import VectorGeneratorInput
