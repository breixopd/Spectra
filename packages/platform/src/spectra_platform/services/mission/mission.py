...
from spectra_platform.mission.core.state_machine import MissionStateMachine
from spectra_platform.mission.core.websocket import manager as ws_manager
...
from spectra_platform.services.ai.blackboard import MissionBlackboard, get_blackboard
from spectra_platform.services.mission.credentials import CredentialStore
...
from spectra_platform.utils.geoip import GeoLocation
...
class Mission:
    ...
    def _apply_mitre_tags(self, finding: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            from spectra_platform.services.ai.mitre_attack import tag_finding_with_attack
