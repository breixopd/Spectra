...
from spectra_platform.telemetry.telemetry import record_tool_execution
from spectra_tools_core.adapter import (
    CommandBuilder,
    ToolAdapter,
    ToolExecutionError,
    UniversalParser,
...
class CommandToolAdapter(ToolAdapter):
    ...
    def build_command(
        ...
        """
        from spectra_platform.services.tools.adapter import runner
