...
class AuditEventType(StrEnum):
    ...
    MISSION_LAUNCH_BLOCKED = "MISSION_LAUNCH_BLOCKED"
    MISSION_CAPABILITY_DENIED = "MISSION_CAPABILITY_DENIED"
    MISSION_DELETED = "MISSION_DELETED"
    MISSION_ARTIFACT_CREATED = "MISSION_ARTIFACT_CREATED"
    MISSION_ARTIFACT_DELETED = "MISSION_ARTIFACT_DELETED"
    MISSION_FILE_DROP_CREATED = "MISSION_FILE_DROP_CREATED"
