...
from spectra_ai_core.prompts import TOOL_SELECTION_PROMPT
...
class ToolSelectorAgent(Agent[ToolSelectorInput, ToolSelectorOutput]):
    ...
    async def _select_with_llm(
        ...
        memory_context = ""
        try:
            from spectra_ai_core.memory import detect_os_from_services, get_memory
        ...
        playbook_context = ""
        try:
            from spectra_ai_core.playbook import get_playbook_engine
        ...
        wordlist_context = ""
        try:
            from spectra_ai_core.wordlists import (
