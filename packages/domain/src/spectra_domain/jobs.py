...
class WorkerJobName(StrEnum):
    ...
    SEND_MISSION_COMPLETION_NOTIFICATION = "send_mission_completion_notification"
    SEND_CRITICAL_FINDING_ALERT = "send_critical_finding_alert"
    GENERATE_MISSION_REPORT = "generate_mission_report"
