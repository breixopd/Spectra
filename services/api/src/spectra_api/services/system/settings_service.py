...
_GENERAL_DB_FIELD_SPECS: tuple[GeneralDbFieldSpec, ...] = (
    ...
    ("sandbox_orchestrator_api_key", "SANDBOX_ORCHESTRATOR_API_KEY", "str", True),
    ("app_name", "APP_NAME", "str", False),
    ("contact_email", "CONTACT_EMAIL", "str", False),
    ("allow_registration", "ALLOW_REGISTRATION", "bool", False),
